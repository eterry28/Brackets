...
function printSortedShows(sortedShows)
{
  ...
  for(i=0; i<32; i++)
  {
    ...
    left += "            <a onclick=\"vote(" + match + "," + i + ");\" href=\"#\" id=\"" + match + "top" + "\">Vote</a>";
    left += "        </div>";
    left += "    </div>";
    i++;
    ...
    left += "        <div class=\"dropdown-content\">";
    left += "            <a href=\"" + sortedShows[i].url + "\" target=\"_blank\">Listen To Theme</a>";
    left += "            <a onclick=\"vote(" + match + "," + i + ");\" href=\"#\" id=\"" + match + "bottom" + "\">Vote</a>";
    left += "        </div>";
    left += "    </div>";
    left += "</div>";
    left += "</div>";
    ...
    right += "            <a onclick=\"vote(" + match + "," + i + ");\" href=\"#\" id=\"" + match + "top" + "\">Vote</a>";
    right += "        </div>";
    right += "    </div>";
    i++;
    ...
    right += "        <div class=\"dropdown-content\">";
    right += "            <a href=\"" + sortedShows[i].url + "\" target=\"_blank\">Listen To Theme</a>";
    right += "            <a onclick=\"vote(" + match + "," + i + ");\" href=\"#\" id=\"" + match + "bottom" + "\">Vote</a>";
    right += "        </div>";
    right += "    </div>";
    right += "</div>";
    right += "</div>";
